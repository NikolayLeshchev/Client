...
public class GetCurrencyIdByNameCommandImpl implements Command {

    private Connection connection = Connector.getInstance().getConnection();

    @Override
    public Message execute(Message message) {
        message.setCommand(CommandEnum.GET_CURRENCY_ID_BY_NAME);
    ...
    public CommandEnum getCommandName() {
        return CommandEnum.GET_CURRENCY_ID_BY_NAME;
    }
}
